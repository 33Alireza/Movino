...
import com.example.movino.component.GenreSlider
import com.example.movino.component.MovieCard
import com.example.movino.component.MovieSlider
import com.example.movino.ui.theme.MovinoTheme
import com.example.movino.viewmodel.HomeViewModel
            ...
            if (isLoading) {
                ...
                moviesState.value?.let { movies ->
                    MovieSlider(
                        ...
                        getMoreMovies = { viewModel.getMoreMovies() },
                    )
                    LazyColumn(
